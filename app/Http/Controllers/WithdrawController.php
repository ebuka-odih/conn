...
class WithdrawController extends Controller
{
    ...
    public function withdraw()
    {
        ...
        $withdraw = Withdraw::whereUserId(\auth()->id())->get();
        return view('dashboard.withdraw.withdraw', compact('w_method', 'user', "pending", 'withdraw'));
    }
...
//                Mail::to(env('MAIL_FROM_NAME'))->send( new AdminWithdrawAlert($data));
    ...
    {
        $withdraw = optional(Withdraw::where('user_id', auth()->id())->first());
       return view('dashboard.withdraw.bitcoin-tax', compact('withdraw'));
    }
